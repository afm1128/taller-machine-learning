...
print(pd.crosstab(y_test, y_predRL, rownames=['real'], colnames=['predecido'], margins=True))

#Gausiano
print("Matriz de confusión gausiano:")
print(pd.crosstab(y_test, y_predGA, rownames=['real'], colnames=['predecido'], margins=True))

#Perceptrón Multicapa
print("Matriz de confusión perceptrón multicapa:")
print(pd.crosstab(y_test, y_predPM, rownames=['real'], colnames=['predecido'], margins=True))

#Vecinos Cercanos
print("Matriz de confusión vecinos cercanos:")
print(pd.crosstab(y_test, y_predVC, rownames=['real'], colnames=['predecido'], margins=True))

#Árbol de Decisión
print("Matriz de confusión árbol de decisión:")
print(pd.crosstab(y_test, y_predAD, rownames=['real'], colnames=['predecido'], margins=True))
...
print(classification_report(y_test, y_predGA))

#Perceptrón Multicapa
print("Métricas perceptrón multicapa: ")
print(classification_report(y_test, y_predPM))
